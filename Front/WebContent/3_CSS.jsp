...
<title>Insert title here</title>
	...
	<style type="text/css">
		...
		p {
			font-family: "돋움";
			color: green;
			background-color: white; /* 색 이름 */
		}
		.blue{
			color: blue;
			background-color: #0000ff;  /* 색 헥스값 */
		}
		#blue2{
			color: blue;
			background-color: rgb(0,255,255); /* RGB 주소값 */
		}
...
<body>
	...
	<p> 색상
	<p> 1. 색이름:[140] 2.헥스값 [ #ffffff ] 3.RGB값
